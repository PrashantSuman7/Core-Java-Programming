...
class ReservationSystemUI {
	...
	public void start() {
		...
		while (true) {
			...
			case 1: {
				...
				System.out.println("Reservation made Successfully With Id " + reservation.getId());
			System.out.println("---------------------------------------");
			}break;
			...
			case 3: {
				...
				break;
			case 4: {
				System.out.println("ThankYou For YOur Appearence");
				return;
			}
	...
	public static void main(String[] args) {
		ReservationSystemUI systemUI=new ReservationSystemUI();
		systemUI.start();
